        ...
        <div class="row">
            <div class="col-lg">
                <table class="table table-hover table-bordered text-gray-900" id="tabelHistoris">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($historis as $h) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="<?= base_url(); ?>adminkantorcabang/detailHistoris/<?= $h["id_historis"]; ?>" class="btn btn-warning btn-sm">
                                        ...
                                        <a href="<?= base_url(); ?>adminkantorcabang/hapusHistoris/<?= $h["id_historis"]; ?>" class="btn badge-danger btn-sm mr-1 tombolHapusHistori">
                    ...
                    <td colspan="4" class="bg-danger text-white text-center"><strong>TOTAL BIAYA</strong></td>
