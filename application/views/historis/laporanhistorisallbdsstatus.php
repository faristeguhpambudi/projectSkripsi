            ...
            <div class="row">
                <div class="col-sm-6 text-gray-900">
                    <div class="form-group row">
                        <label for="status_perangkat" class="col-sm-4 col-form-label"><strong>Pilih Status</strong></label>
                        <div class="col-sm-6">
                            <select name="status_perangkat" id="status_perangkat" class="form-control">
                                <option value="">-- Pilih Status --</option>
                                <?php foreach ($kantorCabang as $kc) : ?>
                                    <option value="<?= $kc["status_perangkat"]; ?>"><?= $kc["keterangan_status"]; ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <div class="col-sm-6 text-gray-900">
                    <div class="form-group row">
                        <div class="col-sm">
                            ...
                            <a href="<?= base_url('admin/cetakLaporanHistorisBdsStatus'); ?>" target="_blank" class="btn btn-danger"><i class="fas fa-print fa-sm mr-1"></i><strong>Cetak Laporan!</strong></a>
                        </div>
                    </div>
                </div>
        </form>
    ...
    <div class="row">
        <div class="col-lg text-gray-900 mb-2">
            <?php if ($historis != null) : ?>
                <strong>Status : <?= $historis[0]["keterangan_status"]; ?></strong>
            <?php endif; ?>
        </div>
    </div>
    <div class="row">
