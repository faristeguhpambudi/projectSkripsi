...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <h2 class="text-center buatfont">
            ...
            <!-- <?php if ($this->session->userdata('kantorCabang')) : ?>
                <p class="text-center buatfont"><strong>Kantor Cabang : </strong></p>
            <?php endif; ?> -->
        </h2>
        <br>
        <div class="ml-5">
            <div class="row">
                <div class="col-lg">
                    <table class="table table-hover table-bordered buatfont">
                        ...
                        <td colspan="5" class="bg-danger text-white text-center buatfont"><strong>TOTAL BIAYA</strong></td>
