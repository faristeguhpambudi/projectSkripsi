            ...
            <div class="row">
                <div class="col-sm-6 text-gray-900">
                    <div class="form-group row">
                        <label for="id_kategori" class="col-sm-4 col-form-label"><strong>Pilih Kategori</strong></label>
                        <div class="col-sm-6">
                ...
                <div class="col-sm-6 text-gray-900">
                    <div class="form-group row">
                        <div class="col-sm">
                            ...
                            <a href="<?= base_url('admin/cetakLaporanHistorisBdsKategori'); ?>" target="_blank" class="btn btn-danger"><i class="fas fa-print fa-sm mr-1"></i><strong>Cetak Laporan!</strong></a>
                        </div>
                    </div>
                </div>
        </form>
    ...
    <div class="row">
        <div class="col-lg text-gray-900 mb-2">
            <?php if ($historis != null) : ?>
                <strong>Kategori : <?= $historis[0]["nama_kategori"]; ?></strong>
            <?php endif; ?>
        </div>
    </div>
    <div class="row">
