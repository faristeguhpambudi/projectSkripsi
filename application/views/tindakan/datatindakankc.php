                    ...
                    <tbody>
                        ...
                        <?php foreach ($tindakan as $t) : ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="<?= base_url(); ?>adminkantorcabang/detailTindakan/<?= $t["id_tindakan"]; ?>" class="btn btn-warning btn-sm">
                                            <i class="fas fa-info-circle fa-sm mr-1"></i>
                                            <strong>Detail</strong>
                                        </a>
                                        <a href="<?= base_url(); ?>adminkantorcabang/ubahDataTindakanKC/<?= $t["id_tindakan"]; ?>" class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit fa-sm mr-1"></i>
                                            <strong>Edit</strong>
                                        </a>
                                        <a href="<?= base_url(); ?>adminkantorcabang/hapusTindakan/<?= $t["id_tindakan"]; ?>" class="btn badge-danger btn-sm mr-1 tombolHapusTindakan">
