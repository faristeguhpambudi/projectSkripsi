            ...
            <div class="ml-5">
                <div class="row">
                    <div class="col-lg text-gray-900">
                        <?= form_open_multipart('adminkantorcabang/ubahPerangkat/' . $perangkatbyid["id_perangkat"]); ?>
                        ...
                        <div class="form-group row justify-content-end">
                            <div class="col-sm-10">
                                <a href="<?= base_url('adminkantorcabang'); ?>" class="btn btn-danger"><strong>Batal!</strong></a>
